	...
	public void processAnswer(String answer, String ID) {
		...
		if (answer != null) {
			...
			case "Play Sound":
				...
				if (file != null) {
					if (ID == "add")
						gui.getLeftPanel().addItem(new SoundCommand(file.toString(), gui));
					else
						gui.getLeftPanel().addItemAt(new SoundCommand(file.toString(), gui));
			...
			case "Record Audio":
				...
				if (rc.file != null && rc.recordFlag == true) {
					if (ID == "add")
						gui.getLeftPanel().addItem(new SoundCommand(rc.file.toString(), gui));
					else
