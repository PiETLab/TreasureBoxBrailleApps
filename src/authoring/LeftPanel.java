...
public class LeftPanel extends JPanel implements KeyListener {
	...
	NewQuestionListener listener = new NewQuestionListener(gui, map, 0);
	...
	public LeftPanel(GUI gui, ColourMapper mapper) {
		...
		commandList.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent arg0) {
				...
				gui.getRightPanel().setInsertBefore(true);
	 ...
	 *            New element to be added
	 */
	public void addItemAt(PlayerCommand newElement) {

		System.out.println(this.InsertIndex);
		listModel.add(this.InsertIndex,newElement);
	...
	/**
	 * Remove a new element before currently selected element from the list .
	 */
	public void InsertItemBefore() {
		InsertIndex = commandList.getSelectedIndex();
		new InsertBefore(this.gui);
	...
	public void deleteItem() {
		commandList.getSelectedIndices();
